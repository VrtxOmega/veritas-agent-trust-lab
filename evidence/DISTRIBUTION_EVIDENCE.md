...
| Surface | Evidence | Verified state |
| --- | --- | --- |
| Public lab | <https://vrtxomega.github.io/veritas-agent-trust-lab/> | Live production URL and public assets returned successfully after deployment. |
| Public source | <https://github.com/VrtxOmega/veritas-agent-trust-lab> | Public repository; release source commit `1f8b76756a6daf24a1e63c764fb3f87baaad55e8`. |
...
The public
[blind-calibration cohort issue](https://github.com/VrtxOmega/veritas-agent-trust-lab/issues/1)
invites the first ten eligible independent pre-reveal label sets and defines
...
The lab offers a bounded **$750 Founding Agent Action Assurance Pilot** with two
slots and explicit nonclaims.
